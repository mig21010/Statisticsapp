...
function generarTabla(numeroDatos) {
	...
	for(var i = 0; i < numeroDatos; i++) {
		...
		var col4 = $('<td>' + ((arregloX[i].value - md) * (arregloX[i].value - md)) + '</td>');
		var col5 = $('<td>' + ((arregloX[i].value - md) * (arregloX[i].value - md)* (arregloX[i].value - md) * (arregloX[i].value - md)) + '</td>');
		var col6 = $('<td>' + ((arregloX[i].value - md) * (arregloY[i].value)) + '</td>');
		var col7 = $('<td>' + (((arregloX[i].value - md) * (arregloX[i].value - md)) * arregloY[i].value)+ '</td>');
